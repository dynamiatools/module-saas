...
public class AccountInfo implements Serializable {
    ...
    public AccountInfo(Long id, String name, String identification,
            ...
            String timeZone, int maxUsers, boolean allowAdditionalUsers, int paymentDay, Date lastPaymentDate, ContactInfo contactInfo) {
        this.id = id;
        this.name = name;
